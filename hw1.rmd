...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hello my name is **Bennet Brosseau** and I am a senior majoring in              *MIS*. I am from Minnesota, therefore, I am a huge Minnesota Vikings             fan. During my free time, I enjoy listening or playing music or                 watching any sort of sporting event on TV.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: I believe a business analyst is a career path related to data                   science. A business analyst is a very broad term for the role, but              most often business analysts use data to either answer questions or             solve a companies problems.
           
            https://www.dataquest.io/blog/career-guide-data-science-options/
            
            https://www.google.com/search?q=business+analyst&tbm=isch&ved=2ahUKEwjsquG8qKjrAhWSQa0KHaJ6DcsQ2-cCegQIABAA&oq=business+analyst&gs_lcp=CgNpbWcQDFAAWABgqeYKaABwAHgAgAEAiAEAkgEAmAEAqgELZ3dzLXdpei1pbWc&sclient=img&ei=qac9X6yyN5KDtQWi9bXYDA&bih=803&biw=1531#imgrc=6hwWrzcr52gt8M
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I think the NFL combine would be an awesome topic to look at. Here              is a link to the dataset I found on Kaggle. 
